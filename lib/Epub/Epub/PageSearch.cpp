// Serialization of a page's flattened search text into the section cache.
// Kept in its own translation unit (rather than Page.cpp) so the search
// feature's cache contribution can evolve without colliding with unrelated
// edits to the much larger page (de)serialization code.
#include <Logging.h>

#include "Page.h"

bool Page::serializeSearchText(FsFile& file) const {
